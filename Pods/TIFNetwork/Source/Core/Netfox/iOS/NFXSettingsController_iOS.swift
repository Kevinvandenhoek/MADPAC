...
final class NFXSettingsController_iOS: NFXSettingsController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad()
    {
        ...
        footerLabel = UILabel(frame: CGRect(x: 10, y: self.view.frame.height - 60, width: self.view.frame.width - 2*10, height: 30))
        footerLabel.autoresizingMask = [.flexibleTopMargin, .flexibleWidth]
        footerLabel.font = UIFont.NFXFont(14)
        footerLabel.textColor = .black
        footerLabel.textAlignment = .center
        footerLabel.text = "TIFNetwork"
