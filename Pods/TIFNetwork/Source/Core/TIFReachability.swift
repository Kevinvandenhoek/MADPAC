...
func callback(reachability:SCNetworkReachability, flags: SCNetworkReachabilityFlags, info: UnsafeMutableRawPointer?) {
    ...
    let reachability = Unmanaged<TIFReachability>.fromOpaque(info).takeUnretainedValue()
...
public class TIFReachability {

    public typealias NetworkReachable = (TIFReachability) -> ()
    public typealias NetworkUnreachable = (TIFReachability) -> ()
...
public extension TIFReachability {
    ...
    func startNotifier() throws {
        ...
        context.info = UnsafeMutableRawPointer(Unmanaged<TIFReachability>.passUnretained(self).toOpaque())        
...
private extension TIFReachability {
