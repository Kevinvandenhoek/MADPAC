//
//  MADNavigationInteractor.swift
//  Madpac
//
//  Created by Kevin van den Hoek on 17/07/2018.
//  Copyright © 2018 Kevin van den Hoek. All rights reserved.
//

import UIKit

class MADNavigationInteractor: UIPercentDrivenInteractiveTransition {
    ...
    @objc private func handleBackGesture(_ gesture : UIScreenEdgePanGestureRecognizer) {
        ...
        case .began:
            ...
            break
        case .changed:
            shouldCompleteTransition = progress > 0.33
            update(progress)
            break
        case .cancelled:
